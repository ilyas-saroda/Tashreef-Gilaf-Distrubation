      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold tracking-tight  text-emerald-500">
            TASHREEF GILAF<span className="text-emerald-500"> </span>
          </h1>
          <div className="hidden sm:flex items-center gap-2 px-2 py-0.5 rounded bg-white border border-slate-200">
            ...
            >
              {isSyncing ? (
                ...
                <RefreshCcw className="w-3 h-3 text-emerald-500 group-hover:rotate-180 transition-transform duration-500" />
              )}
            ...
            {supabaseStatus === "connected" ? (
              ...
              <div
                ...
                title="Set Supabase keys in Settings to enable Cloud Sync"
              >
